...
class PreferencesRepoImpl @Inject constructor(private val dataStore: DataStore<Preferences>) : PreferencesRepo {
    ...
    override suspend fun saveMbrId(mbrId: String) {
    ...
    override suspend fun saveQrOnOpenPref(qrOnOpen: Boolean) {
    ...
    override suspend fun saveQrMaxBrightnessPref(qrMaxBrightness: Boolean) {
        dataStore.edit { preferences ->
    ...
    override suspend fun saveNtpPref(useNtp: Boolean) {
        dataStore.edit { preferences ->
            preferences[USE_NTP] = useNtp
        }
    }
    override suspend fun saveNtpServ(ntpServer: String) {
        dataStore.edit { preferences ->
